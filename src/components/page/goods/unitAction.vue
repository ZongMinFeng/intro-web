  ...
  <div class="container">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible">
      <el-form :model="dialogForm" label-width="80px" ref="dialogForm">
        <el-row>
          <el-col :span="24">
            <el-form-item label="名称" prop="unitName" :rules="[{required:true, message:'请输入名称', trigger: 'blur'}]">
...
<script>
  import {addGooUnitinfo, deleteGooUnitinfoById, listAllUnitinfos} from "../../../util/module";
