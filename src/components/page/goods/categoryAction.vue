        ...
        <el-table :data="tableData" border stripe>
            ...
            <el-table-column label="操作">
                <template slot-scope="props">
                    ...
                    <el-button v-if="props.row.isLeaf==='Y'" type="danger" @click="deleteTap(props.row)">删除</el-button>
                    <el-button v-if="props.row.isLeaf==='N'" type="primary" @click="getChildren(props.row)">子类 &nbsp;&gt;&gt;&nbsp;</el-button>
                    <el-button type="success" v-if="props.row.isLeaf==='Y'" @click="addChild(props.row)">新增子类
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
                    ...
                    <el-col :sapn="24">
                        <el-form-item label="状态">
                            <el-select v-model="dialogForm.status" placeholder="请选择状态" style="width: 100%;">
                                <el-option v-for="item in allStatus" :key="item.id" :label="item.value"
