            ...
            <el-row>
                <el-col :span="6">
                    <el-form-item label="订单状态">
                        <el-select v-model="searchForm.status" clearable placeholder="请选择订单状态" style="width: 100%;">
...
<script>
    import {
        ...
        listAllOrders, listMyCustomerOrders
    } from "../../../util/module";
    ...
    export default {
        ...
        methods: {
            ...
            getOrders() {
                ...
                listMyCustomerOrders(this, params).then(
                    res => {
                        this.tableData = [];
                        if (res.data == null) {
                            return;
