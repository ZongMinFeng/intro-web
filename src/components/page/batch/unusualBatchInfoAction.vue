<template>
    <div class="container">
        ...
        <el-table :data="tableData" border stripe>
            ...
            <el-table-column key="11" label="备注" prop="memo"></el-table-column>
        </el-table>
...
<script>
    import {
        ...
        listBatchGoodsByCon, listKilledBatchGoodsByCon, putonBatch, submitLocalPrice, submitReportPrice,
    ...
    export default {
        ...
        methods: {
            ...
            getGoodsSerials() {
                ...
                params.batchId = this.batchInfo.batchId;
                listKilledBatchGoodsByCon(this, params).then(
                    res => {
