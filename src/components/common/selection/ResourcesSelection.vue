<template>
  <div>
    ...
    <h3 style="margin-top: 10px; margin-bottom: 5px">资源列表</h3>
    ...
    <h3 style="margin-top: 10px; margin-bottom: 5px">此次已选资源</h3>
      ...
      methods:{
        ...
        checkAll(){
          ...
          this.tableData.forEach((value, index)=>{
            for(let i=0; i<this.resouces.length; i++){
              if (this.resouces[i].resourceId===value.resourceId){
          ...
          if(selection.length>this.tableDataSelections.length){
            ...
            selection.forEach((value)=>{
              ...
              for(let i=0; i<this.tableDataSelections.length; i++){
                if(value.resourceId===this.tableDataSelections[i].resourceId){
                  haveIt=true;
                  break;
                }
              }
        ...
        deleteResource(row){
          this.tableData.forEach((value)=>{
            if(value.resourceId===row.resourceId){
