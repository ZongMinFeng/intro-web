...
module.exports = {
    ...
    service: {
        ...
        addGoodsQualitycertify: {
            url: baseUrl + '/goods/addGoodsQualitycertify',
            txnId: 'addGoodsQualitycertify'
        },
        deleteGoodsQualitycertifyById: {
            url: baseUrl + '/goods/deleteGoodsQualitycertifyById',
            txnId: 'deleteGoodsQualitycertifyById'
        },
        updateGoodsQualitycertifyById: {
            url: baseUrl + '/goods/updateGoodsQualitycertifyById',
            txnId: 'updateGoodsQualitycertifyById'
        },
        getGoodsQualitycertifyById: {
            url: baseUrl + '/goods/getGoodsQualitycertifyById',
            txnId: 'getGoodsQualitycertifyById'
        },
        addGoodsserial: {
            url: baseUrl + '/goods/addGoodsserial',
            txnId: 'addGoodsserial'
        },
        deleteGoodsserialById: {
            url: baseUrl + '/goods/deleteGoodsserialById',
            txnId: 'deleteGoodsserialById'
        },
        deleteGoodsserialByGoodsId: {
            url: baseUrl + '/goods/deleteGoodsserialByGoodsId',
            txnId: 'deleteGoodsserialByGoodsId'
        },
        updateGoodsserialById: {
            url: baseUrl + '/goods/updateGoodsserialById',
            txnId: 'updateGoodsserialById'
        },
        getGoodsserialById: {
            url: baseUrl + '/goods/getGoodsserialById',
            txnId: 'getGoodsserialById'
        },
        listGoodsserialsByGoodsId: {
            url: baseUrl + '/goods/listGoodsserialsByGoodsId',
            txnId: 'listGoodsserialsByGoodsId'
        },
